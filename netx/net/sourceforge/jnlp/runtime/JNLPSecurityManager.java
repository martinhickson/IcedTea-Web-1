...
class JNLPSecurityManager extends SecurityManager {
    ...
    public void checkPermission(Permission perm) {
        ...
        // Do not deny SocketPermission resolve. Skipping PTR on private
        // literals was a perf shortcut; it threw SecurityException on
        // localhost / 127.0.0.1 / RFC1918 and broke trusted HTTP clients.

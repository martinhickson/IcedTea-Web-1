...
TARGET="$ROOT/target"
SOURCE="$ROOT/src/test/java/net/sourceforge/icedteaweb/it/apps/HeadlessHoldJnlpMain.java"
...
Main-Class: net.sourceforge.icedteaweb.it.apps.HeadlessHoldJnlpMain
...
compile_sample "${ITW_JDK17_HOME:-/usr/lib/jvm/java-17-openjdk-amd64}" java17-app "ITW Java 17 bytecode app"
compile_sample "${ITW_JDK21_HOME:-/usr/lib/jvm/java-21-openjdk-amd64}" java21-app "ITW Java 21 bytecode app"
compile_sample "${ITW_JDK25_HOME:-/usr/lib/jvm/java-25-openjdk-amd64}" java25-app "ITW Java 25 bytecode app"
